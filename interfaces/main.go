...
structs are concrete types in Go's type system
interface type provides contracts to user-defined concrete types,
which allows you to define behaviours for your objects.
